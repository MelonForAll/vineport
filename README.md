...
Grab the latest **Vineport.zip** from the [Releases](https://github.com/MelonForAll/vineport/releases) page. Unzip it, drag **Vineport.app** to your Applications folder (or anywhere), and double-click. On first launch it downloads Wine (~190 MB) and sets everything up automatically. (Prefer building from source? See the Quick Start below.)
